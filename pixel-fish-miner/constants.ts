...
export const FISH_TYPES: FishType[] = [
  ...
  {
    id: "fluorescent_squid",
    name: "Fluorescent Squid",
    rarity: FishRarity.RARE,
    weight: 45,
    value: 300,
    speed: 1.8,
  ...
  // Costume-unlocked (Marine Scientist)
  {
    id: "nautilus",
    name: "Nautilus",
