export const en = {
  ...
  confirmBetTitle: "Whoa, Big Spender!",
  confirmBetMessage: "Are you sure you want to bet ${0} on one spin?",
  confirmBetYes: "Let's Go!",
  confirmBetNo: "Maybe Not",
  halfBetLocked: "🔒 Half (Need $4,000)",
  ...
  promoMessages: {
    ...
    timeNight: "It's nighttime! 🌙",
    timeDay: "It's daytime! ☀️",
  },
  fish: {
    sardine: "Sardine",
    herring: "Herring",
