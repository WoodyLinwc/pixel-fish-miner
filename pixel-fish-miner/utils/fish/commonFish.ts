...
export const drawSmallYellowCroaker = (
  ctx: CanvasRenderingContext2D,
  w: number,
  h: number,
) => {
...
export const drawMackerel = (
  ...
  for (let i = 0; i < 3; i++) {
    // Reduced from 4 to 3 to remove the front-most floating stripe
